...
def get_access_code():
    access_code = input("\033[1;32m ⋮ Enter the code to access the page.UI >> \033[1;197m\033[1;91m")
    return access_code

def CNP():
    os.system("title Movie Shop")
...
"""))
    ...
    # ตรวจสอบว่ารหัสที่ผู้ใช้ใส่ตรงกับรหัสที่คุณต้องการหรือไม่
    if access_code == "MESMS":
        print(green("ยินดีต้อนรับ! คุณเข้าถึงหน้า UI แล้ว"))
        # ทำสิ่งที่คุณต้องการทำเมื่อรหัสผ่านถูกต้อง
    else:
...
def CNP():
    os.system("title Movie Shop to sms")
    print(Colorate.Horizontal(Colors.rainbow, """
                 __  __  ____      ____  _____      ___  __  __  ___ 
                (  \/  )( ___)    (_  _)(  _  )    / __)(  \/  )/ __)
                 )    (  )__)       )(   )(_)(     \__ \ )    ( \__ \                         
                (_/\/\_)(____)     (__) (_____)    (___/(_/\/\_)(___/
    ...
    ╚═╝     ╚═╝ ╚═════╝   ╚═══╝  ╚═╝╚══════╝    ╚══════╝╚═╝  ╚═╝ ╚═════╝ ╚═╝         
   ╔════════════════════════════════════════════════════════════════════════════╗
   ║       # : Movie to SMS.   # Discord : https://discord.gg/d5ZnQVjCV9        ║
   ╚════════════════════════════════════════════════════════════════════════════╝
"""))
    print("")
    print("")
    phone = input("\033[1;32m⋮ Telephone >>>\033[1;197m\033[0;19m ")
    count = int(input("\033[1;32m⋮ Number >>>\033[1;19m\033[0;19m "))
    print()
    sleep(2)
